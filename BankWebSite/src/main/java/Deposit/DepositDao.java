...
public class DepositDao {
	...
	public boolean returnAccNo(DepositUser us, String username) throws SQLException, ClassNotFoundException {
	...
	public int updateCreditBalance(int pin,String username ,DepositUser us) throws SQLException, ClassNotFoundException {
	...
	public double showBalance(DepositUser us, String username) throws SQLException, ClassNotFoundException {
