	    ...
	    <div class="main">
	          ...
	          <div class="right">
	                    ...
	                    <div class="form">
	                            ...
	                            <h1>Mobile<br>recharge</h1><br>
  
	                   	                                                       	
                            	<input type="text" name="mobileNum" placeholder="Enter Mobile Number" maxlength="10" required><br>
                            	
                            	<h3>Select operator</h3>
                            	
                               	<select id="operator" name="operator" placeholder="Select Operator" required>
                                 ...
                                 <br>                     	 
                       			<button>Select plans</button><br>
                       			
                       			<% boolean flag = Boolean.parseBoolean(request.getParameter("flag")); %>
                       			
                       			<% if(flag == true) { %>
	                       			<h3 style="color:red; margin-left:20px"> Enter valid mobile number !</h3>
	                       		<% } %>
