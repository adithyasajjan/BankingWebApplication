...
<body>
	<form action="FastagCharge" method="Post">
		    ...
		    <div class="main">
		          ...
		          <div class="right">
		                    ...
		                    <div class="form">
	                            	...
	                            	<input type="number" name="amount" placeholder="Enter amount"  min="1" required><br>
	                       			...
	                       			<% if(flag1 == true) { %>
	                       				<h3 style="color:red; margin-left:20px"> Incorrect pin !</h3>
	                       			<% } %>
	                       			...
	                       			<% if(flag3 == true) { %>
	                       				<h3 style="color:red; margin-left:10px"> Insufficient funds ! </h3>
	                       			<% } %>
